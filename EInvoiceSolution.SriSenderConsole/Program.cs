...
using EInvoiceSolution.SriSenderConsole.Services;
using EInvoiceSolution.SriSenderConsole.Workers;
...
// Workers
builder.Services.AddSingleton<ISenderWorker, SenderWorker>();

var app = builder.Build();

var worker = app.Services.GetRequiredService<ISenderWorker>();
